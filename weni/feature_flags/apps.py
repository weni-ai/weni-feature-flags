...
class WeniFeatureFlagsConfig(AppConfig):
    ...
    def ready(self):
        from weni.feature_flags.settings import USE_SCHEDULED_UPDATES

        if not USE_SCHEDULED_UPDATES:
            return
    ...
    def _setup_periodic_task(self):
        ...
        from weni.feature_flags.settings import SCHEDULED_UPDATE_INTERVAL
        ...
        beat_schedule[PERIODIC_TASK_NAME] = {
            ...
            "schedule": SCHEDULED_UPDATE_INTERVAL,
        }
